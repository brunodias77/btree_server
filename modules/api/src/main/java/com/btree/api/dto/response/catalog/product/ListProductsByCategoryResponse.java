...
import com.btree.application.usecase.catalog.product.list_products_by_category.ListProductsByCategoryOutput;
...
public record ListProductsByCategoryResponse(
    ...
    public record ProductSummaryResponse(
        ...
        public static ProductSummaryResponse from(final ListProductsByCategoryOutput.ProductSummary item) {
